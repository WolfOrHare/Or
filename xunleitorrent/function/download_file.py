...
def parse_index(res):
    ...
    # 资源详情class="dropdown".*?href="(.*?)"
    # 地址页class="origin" http://xunleib.zuida360.com/1810/麻烦了客栈.HD1280高清国语中字版.mp4
    #     <span class="copy" data-clipboard-text="http://xunleib.zuida360.com/1810/麻烦了客栈.HD1280高清国语中字版.mp4">复制</span>
